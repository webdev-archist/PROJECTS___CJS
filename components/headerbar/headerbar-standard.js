...
export default class HeaderbarStandard extends Headerbar{
     ...
     constructor(){
          super()
          this.component = {h1:"logo",menu:"primary",ul:"secondary",form:"headerbar",button:"responsive"}
     }
     yo(){alert('ok')}
     ...
     connectedCallback(){
          ...
          this.data = cjsdatafile[this.COMPONENT_NAME] || cjsdatafile[this.COMPONENT_NAME.replace('_','-')]
          ...
          this.$form.append($('<input/>').attr({'type': 'submit', 'placeholder': 'Search'}))
